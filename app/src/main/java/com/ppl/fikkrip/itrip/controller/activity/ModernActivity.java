...
public class ModernActivity extends AppCompatActivity {
    ...
    private void getData(String idPulau) {
        ...
        RequestQueue queue = Volley.newRequestQueue(ModernActivity.this);
    ...
    private void getProvinsi(JSONArray j) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(ModernActivity.this, android.R.layout.simple_spinner_dropdown_item, provinsiList));
    }
